...
Approach:
We can only make the strings same when count of each character in both the strings combined is even.
...
str1=s+t 
set1=set(str1) #to get unique characters , no repetition 
for i in set1:
	if str1.count(i)%2!=0:
		return False
return True